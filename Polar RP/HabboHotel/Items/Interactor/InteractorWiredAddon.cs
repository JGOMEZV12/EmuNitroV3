...
{
    public class InteractorWiredAddon : IFurniInteractor
    {
        ...
        public void OnTrigger(GameClient Session, Item Item, int Request, bool HasRights)
        {
            ...
            List<int> BlockedItems = WiredBoxTypeUtility.ContainsBlockedTrigger(Box, Item.GetRoom().GetWired().GetConditions(Box));
