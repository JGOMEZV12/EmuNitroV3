...
{
    class AddonFilterFurniByVariableBox : IWiredItem
    {
        public Room Instance { get; set; }
        public Item Item { get; set; }
        public WiredBoxType Type => WiredBoxType.AddonFilterFurniByVariable;
        ...
        public AddonFilterFurniByVariableBox(Room instance, Item item)
        {
            Instance = instance;
            Item = item;
        ...
        public bool Execute(params object[] @params)
        {
            ...
            context.SelectedItems = context.SelectedItems.Where(it => {
