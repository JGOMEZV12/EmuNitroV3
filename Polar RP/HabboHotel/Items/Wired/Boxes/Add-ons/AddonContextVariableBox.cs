...
{
    class AddonContextVariableBox : IWiredItem, IWiredCustomData
    {
        public Room Instance { get; set; }
        public Item Item { get; set; }
        public WiredBoxType Type => WiredBoxType.AddonContextVariable;
        ...
        public AddonContextVariableBox(Room instance, Item item)
        {
            Instance = instance;
            Item = item;
