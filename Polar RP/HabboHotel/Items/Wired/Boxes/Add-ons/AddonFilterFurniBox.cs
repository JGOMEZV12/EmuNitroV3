...
{
    class AddonFilterFurniBox : IWiredItem, IWiredCustomData
    {
        ...
        public void HandleSave(ClientPacket packet)
        {
            ...
            // Java: si el int es 0 intenta parsear el string
            if (rawAmount == 0 && !string.IsNullOrEmpty(strParam) &&
                int.TryParse(strParam, out int parsed))
                rawAmount = parsed;

            Console.WriteLine($"[AddonFilterFurniBox] HandleSave — amount={rawAmount}");
        ...
        public void LoadWiredData(string wiredData)
        {
            ...
            {
                // Retrocompatibilidad: formato viejo era solo el amount
