...
{
    class AddonFurniVariableBox : IWiredItem
    {
        ...
        public AddonFurniVariableBox(Room instance, Item item)
        {
            ...
            StringData = "";
            Instance.GetFurniVariableManager().RegisterDefinition(this);
        }
        ...
        public void HandleSave(ClientPacket packet)
        {
            ...
            int availability = packet.PopInt(); // 1 = Room Active, 10 = Permanent
