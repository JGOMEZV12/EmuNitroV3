...
{
    class AddonVariableTextConnectorBox : IWiredItem, IWiredCustomData
    {
        public Room Instance { get; set; }
        public Item Item { get; set; }
        public WiredBoxType Type => WiredBoxType.AddonVariableTextConnector;
        ...
        public AddonVariableTextConnectorBox(Room instance, Item item)
        {
            Instance = instance;
            Item = item;
