    ...
    class VariableAddBox : IWiredItem
    {
        ...
        public bool Execute(params object[] @params)
        {
            ...
            if (player != null)
            {
                ...
                {
                    Instance.GetUserVariableManager().SetValue(player.Id, varName, (userVal + addValue).ToString());
                }
            }
            ...
            {
                Instance.GetRoomVariableManager().SetValue(varName, (roomVal + addValue).ToString());
            }
            ...
            foreach (var item in SetItems.Values)
            {
                ...
                {
                    Instance.GetFurniVariableManager().SetValue(item.Id, varName, (furniVal + addValue).ToString());
                }
            }
