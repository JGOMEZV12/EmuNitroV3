...
{
    class UsersSignalBox : IWiredItem, IWiredCustomData
    {
        public Room   Instance { get; set; }
        public Item   Item     { get; set; }
        public WiredBoxType Type => WiredBoxType.SelectorUsersSignal;
        ...
        public UsersSignalBox(Room Instance, Item Item)
        {
        ...
        public string GetWiredData() => JsonConvert.SerializeObject(new JsonData { filterExisting = this.filterExisting, invert = this.invert, delay = this.delay });
        ...
        public void Serialize(ServerPacket Packet)
        {
            ...
            Packet.WriteString(""); Packet.WriteInteger(2);
        ...
        private void ResetData() { this.filterExisting = false; this.invert = false; this.delay = 0; }

        private class JsonData { public bool filterExisting { get; set; } public bool invert { get; set; } public int delay { get; set; } }
    }
}
