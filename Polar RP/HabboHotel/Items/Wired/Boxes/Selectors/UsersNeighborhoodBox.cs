...
{
    class UsersNeighborhoodBox : IWiredItem, IWiredCustomData
    {
        ...
        public WiredBoxType Type => WiredBoxType.SelectorUsersNeighborhood;
        ...
        public UsersNeighborhoodBox(Room Instance, Item Item)
        {
        ...
        {
            // intParams: [sourceType, filterExisting, invert, targetOffsetX, targetOffsetY, n, x0, y0, …]
