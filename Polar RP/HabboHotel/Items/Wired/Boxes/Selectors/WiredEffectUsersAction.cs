...
{
    class WiredEffectUsersAction : WiredEffectVariableSelectorBase
    {
        public WiredEffectUsersAction(Room instance, Item item) : base(instance, item) { }
        public override WiredBoxType Type => WiredBoxType.EffectUsersAction;
